# Résumé du cours INFO-F307 - Génie logiciel et gestion de projets.

## Qu'est-ce donc ce répertoire ?
Ce répertoire contient le résumé en PDF (via LaTeX) du cours INFO-F307 - Génie logiciel et gestion de projets de l'Université Libre de Bruxelles. Ce résumé dispose de la même table des matières que le cours (dans la mesure du possible).
